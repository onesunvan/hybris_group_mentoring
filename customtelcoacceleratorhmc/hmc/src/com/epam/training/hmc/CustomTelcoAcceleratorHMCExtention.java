...
public class CustomTelcoAcceleratorHMCExtention extends HMCExtension {
    /**
     * Edit the local|project.properties to change logging behavior (properties log4j.*).
     */
    @SuppressWarnings("unused")
    private static final Logger LOG = Logger.getLogger(CustomTelcoAcceleratorHMCExtention.class.getName());
