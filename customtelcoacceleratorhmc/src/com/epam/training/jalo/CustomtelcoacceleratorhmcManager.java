...
import com.epam.training.constants.CustomtelcoacceleratorhmcConstants;



/**
 * This is the extension manager of the Customtelcoacceleratorhmc extension.
 */
public class CustomtelcoacceleratorhmcManager extends GeneratedCustomtelcoacceleratorhmcManager
{
	/** Edit the local|project.properties to change logging behavior (properties 'log4j.*'). */
	private static final Logger LOG = Logger.getLogger(CustomtelcoacceleratorhmcManager.class.getName());
	 ...
	 */
	public static CustomtelcoacceleratorhmcManager getInstance()
	{
		return (CustomtelcoacceleratorhmcManager) Registry.getCurrentTenant().getJaloConnection().getExtensionManager().getExtension(
				CustomtelcoacceleratorhmcConstants.EXTENSIONNAME);
	}
	 ...
	 */
	public CustomtelcoacceleratorhmcManager() // NOPMD 
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("constructor of CustomtelcoacceleratorhmcManager called.");
		}
	}
	...
	public void init()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("init() of CustomtelcoacceleratorhmcManager called. " + getTenant().getTenantID());
		}
	}
	...
	public void destroy()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("destroy() of CustomtelcoacceleratorhmcManager called, current tenant: " + getTenant().getTenantID());
		}
	}
