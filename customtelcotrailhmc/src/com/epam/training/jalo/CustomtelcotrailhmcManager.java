...
import com.epam.training.constants.CustomtelcotrailhmcConstants;



/**
 * This is the extension manager of the Customtelcotrailhmc extension.
 */
public class CustomtelcotrailhmcManager extends GeneratedCustomtelcotrailhmcManager
{
	/** Edit the local|project.properties to change logging behavior (properties 'log4j.*'). */
	private static final Logger LOG = Logger.getLogger(CustomtelcotrailhmcManager.class.getName());
	 ...
	 */
	public static CustomtelcotrailhmcManager getInstance()
	{
		return (CustomtelcotrailhmcManager) Registry.getCurrentTenant().getJaloConnection().getExtensionManager().getExtension(
				CustomtelcotrailhmcConstants.EXTENSIONNAME);
	}
	 ...
	 */
	public CustomtelcotrailhmcManager() // NOPMD 
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("constructor of CustomtelcotrailhmcManager called.");
		}
	}
	...
	public void init()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("init() of CustomtelcotrailhmcManager called. " + getTenant().getTenantID());
		}
	}
	...
	public void destroy()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("destroy() of CustomtelcotrailhmcManager called, current tenant: " + getTenant().getTenantID());
		}
	}
