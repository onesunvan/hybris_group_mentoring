...
public abstract class AbstractParsingPkResolvingStrategy implements PkResolvingStrategy {
    ...
    /**
     * @param urlParsingStrategy the urlParsingStrategy to set
     */
     ...
     * @param key the key
     * @return model
     * @throws UnknownIdentifierException   if the model could not be found
     * @throws AmbiguousIdentifierException if the model cannot be uniquely identified
     */
