...
public interface VariantSortStrategy extends Comparator<VariantOptionData> {
     ...
     *
     * @param fields the new sorting fields order
     */
    ...
    /**
     * @param defaultComparator for comparing variants' values - used as fallback, provide your own in {@link #setComparators(Map)}
     */
