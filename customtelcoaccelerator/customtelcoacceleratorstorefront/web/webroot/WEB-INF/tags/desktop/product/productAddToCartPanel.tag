        ...
        <form:form id="addToCartForm" class="add_to_cart_form" action="${addToCartUrl}" method="post">
            <div class="tabbody device-only">
                ...
                <c:if test="${product.stock.stockLevel gt 0}">
                    <c:set var="productStockLevel">${product.stock.stockLevel}&nbsp;<spring:theme
                ...
                <div class="tabbody">
                    ...
                    <div class="subTabs">
                        ...
                        <c:forEach items="${bundleTab.frequencyTabs}" var="frequencyTab"
                                   varStatus="frequencyTabCounter">
                            <h3><c:if
                                    test="${frequencyTab.termOfServiceNumber gt 0}">${frequencyTab.termOfServiceNumber} &nbsp;</c:if>
                                ${frequencyTab.termOfServiceFrequency.name}</h3>
                                ...
                                <table class="sub-tabbody-table">
                                    ...
                                    <c:forEach items="${frequencyTab.products}" var="plan" varStatus="plansCounter">
                                        ...
                                        <tr>
                                            ...
                                            <td class="sub-tabbody-table-td1">${plan.name} <a
                                                    class="details detail-${bundleTabCounter.count}_${frequencyTabCounter.count}_${plansCounter.count}"
                                                    tabindex="0" title="Details"><spring:theme code="product.overview"
                                                                                               text="Details"/></a>

                                                <div style="display:none">
                                                    <div id="detail-${bundleTabCounter.count}_${frequencyTabCounter.count}_${plansCounter.count}">
                                                        <div class="small_popup_container"
                                                             style="border-top: 0; margin-top: 0; border-bottom: 0;">
                                                            <div class="small_popup_headline">
                                                                <div class="small_popup_emark">
                                                                </div>
                                                                <div class="small_popup_headline_text">
                                                                        ${plan.name} <spring:theme
                                                                        code="product.overview" text="Details"/>
                                                                </div>
                                                                <div class="clear"></div>
                                                            </div>
                                                            <div class="small_popup_content">
                                                                <c:if test="${plan.subscriptionTerm.termOfServiceNumber gt 0}">${plan.subscriptionTerm.termOfServiceNumber} &nbsp;</c:if>${plan.subscriptionTerm.termOfServiceFrequency.name}
                                                                , ${plan.subscriptionTerm.termOfServiceRenewal.name}
                                                                <br>
                                                                <c:if test="${not empty plan.price.recurringChargeEntries}">
                                                                    <c:set var="recurringChargeCount"
                                                                           value="${fn:length(plan.price.recurringChargeEntries)}"/>
                                                                    <c:forEach
                                                                            items="${plan.price.recurringChargeEntries}"
                                                                            var="recurringPrice"
                                                                            varStatus="recurringPricesCounter">
                                                                        <c:choose>
                                                                            <c:when test="${recurringPrice.cycleEnd == '-1'}">
                                                                                <c:if test="${recurringChargeCount gt 1}">
                                                                                    <spring:theme
                                                                                            code="product.list.viewplans.price.interval.unlimited"
                                                                                            arguments="${recurringPrice.cycleStart}"/>
                                                                                </c:if>
                                                                                <format:price
                                                                                        priceData="${recurringPrice.price}"/>
                                                                            </c:when>
                                                                            <c:otherwise>
                                                                                <c:if test="${recurringChargeCount gt 1}">
                                                                                    <spring:theme
                                                                                            code="product.list.viewplans.price.interval"
                                                                ...
                                                                <c:if test="${not empty plan.price.oneTimeChargeEntries}">
                                                                    ...
                                                                    <c:forEach
                                                                            items="${plan.price.oneTimeChargeEntries}"
                                                                            var="oneTimePrice"
                                                                            varStatus="oneTimePricesCounter">
                                                                        <c:if test="${not oneTimePricesCounter.first}">
                                                                            <br/>
                                                                        </c:if>
                                                                        <spring:theme
                                                                                code="product.list.viewplans.price.onetime"
                                                                                arguments="${oneTimePrice.name}"/>
                                                                        <format:price
                                                                                priceData="${oneTimePrice.price}"/>
                                                                        <spring:theme
                                                                                code="product.details.oneTimePrice.billingTime.suffix"
                                                                                arguments="${oneTimePrice.billingTime.name}"/>
                                                                        <br>
                                                                    </c:forEach>
                                                                </c:if>
                                                                ...
                                                                <c:if test="${not empty plan.classifications}">
                                                                    <br>
                                                                    <c:forEach items="${plan.classifications}"
                                                                               var="classification">
                                                                ...
                                                                <c:if test="${not empty plan.entitlements}">
                                                                    <br>
                                                                    <c:forEach items="${plan.entitlements}"
                                                                               var="entitlement">
                                                                        <spring:theme
                                                                                code="product.details.entitlements"
                                                                                arguments="${entitlement.name}"/>
                                                                        <c:if test="${entitlement.usageUnit eq null}">
                                                                            <spring:theme
                                                                                    code="product.list.viewplans.entitlements.true"
                                                                                    text="true"/>
                                                                        </c:if>
                                                                        <c:if test="${entitlement.usageUnit ne null}">
                                                                            <c:choose>
                                                                                <c:when test="${entitlement.quantity lt 0}">
                                                                                    <spring:theme
                                                                                            code="product.list.viewplans.entitlements.unlimited"/>
                                                                                </c:when>
                                                                                <c:when test="${entitlement.quantity eq 1}">
                                                                                    <spring:theme
                                                                                            code="product.list.viewplans.entitlements.meteredEntitlement"
                                                                                            arguments="${entitlement.quantity}^${entitlement.usageUnit.name}"
                                                                                            argumentSeparator="^"/>
                                                                                </c:when>
                                                                                <c:otherwise>
                                                                                    <spring:theme
                                                                                            code="product.list.viewplans.entitlements.meteredEntitlement"
                                                                                            arguments="${entitlement.quantity}^${entitlement.usageUnit.namePlural}"
                                                                                            argumentSeparator="^"/>
                                                                                </c:otherwise>
                                                                            </c:choose>
                                                                        </c:if>
                                                                ...
                                                                <c:if test="${not empty plan.price and not empty plan.price.usageCharges}">
                                                                    <br>
                                                                    <c:forEach items="${plan.price.usageCharges}"
                                                                               var="usageCharge">
                                                                        <spring:theme
                                                                                code="product.details.usageCharges"
                                                                                arguments="${usageCharge.name}"/>
                                                                        <c:if test="${not empty usageCharge.usageChargeEntries}">
                                                                            <c:forEach
                                                                                    items="${usageCharge.usageChargeEntries}"
                                                                                    var="usageChargeEntry">
                                                                                <c:if test="${usageChargeEntry['class'].simpleName eq 'TierUsageChargeEntryData'}">
                                                                                    <spring:theme
                                                                                            code="product.list.viewplans.tierUsageChargeEntry"
                                            ...
                                            <td class="sub-tabbody-table-td2"><format:price
                                                    priceData="${plan.otherBundleProductPrice}"/>
                                                <div class="pay"><spring:theme code="product.payNow"
                                                                               text="pay now"/></div>
                                            </td>
                                            <td class="sub-tabbody-table-td3">
                                                <c:set var="basePrice" value="${null}"/>
                                                <c:if test="${not empty plan.price.recurringChargeEntries}">
                                                    <c:forEach items="${plan.price.recurringChargeEntries}"
                                                               var="recurringChargeEntry"
                                                               varStatus="recurringChargeEntryCounter">
                                                ...
                                                <c:if test="${not empty basePrice and (basePrice.value - plan.thisBundleProductPrice.value) > 0}">
                                                    <del><format:price priceData="${basePrice}"
                                                                       displayFreeForZero="true"/></del>
                                                </c:if>
                                                <format:price priceData="${plan.thisBundleProductPrice}"/>
                                                <div class="pay">${plan.subscriptionTerm.billingPlan.billingTime.name}</div>
                                            </td>
                                            <td class="sub-tabbody-table-td4">
                                                <form:form class="bundle_add_to_cart_form"
                                                           id="bundleAddToCartForm${bundleTabCounter.count}_${frequencyTabCounter.count}_${plansCounter.count}"
                                                           action="${addToCartBundle}" method="post">
                                                    <spring:theme code="text.addToCart" var="addToCartText"/>
                                                    <div id="${plan.code}">
                                                        ...
                                                        <button type="${buttonTypeBundle}"
                                                                class="positive large delayed-button <c:if test="${fn:contains(buttonTypeBundle, 'button')}">out-of-stock</c:if>">
                                                            <spring:theme code="text.addToCart" var="addToCartText"/>
                                                            <spring:theme code="basket.add.to.basket"/>
                                                        </button>
                                                    </div>
                                                    ...
                                                    <input type="hidden" name="bundleTemplateId1"
                                                           value="${bundleTab.sourceComponent.id}"/>
                                                    <input type="hidden" name="bundleTemplateId2"
                                                           value="${bundleTab.targetComponent.id}"/>
                                                </form:form>
                                            </td>
                        ...
                        <tr>
                            ...
                            <c:if test="${product.stock.stockLevelStatus.code eq 'inStock' and product.stock.stockLevel le 0}">
                                <td class="item-only-variants">
                                    <c:set var="productStockLevel"><spring:theme
                            ...
                            <td class="item-only-add">
                                ...
                                <spring:theme code="text.addToCart" var="addToCartText"/>
                                <button type="${buttonType}"
                                        class="positive large delayed-button <c:if test="${fn:contains(buttonType, 'button')}">out-of-stock</c:if>">
                                    <spring:theme code="text.addToCart" var="addToCartText"/>
                                    <spring:theme code="basket.add.to.basket"/>
                                </button>
                            </td>
