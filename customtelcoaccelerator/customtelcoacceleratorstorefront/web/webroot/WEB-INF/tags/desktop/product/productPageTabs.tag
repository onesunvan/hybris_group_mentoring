            ...
            <li id="tab_01">
                <h2>
                    <a href="#tab-details" class="tab_01"
                       title="<spring:theme code="product.product.details" />"><spring:theme
                            code="product.product.details"/></a>
                </h2>
            </li>
            <li>
                <h2>
                    <a href="#tab-reviews" class="tab_03" title="<spring:theme code="review.reviews" />"><spring:theme
                            code="review.reviews"/></a>
                </h2>
            </li>
        </ul>
    </ycommerce:testId>
