        ...
        <div class="grid-product-price">
            <ycommerce:testId code="product_productPrice">
                ...
                <c:if test="${product.lowestBundlePrice ne null and product.lowestBundlePrice.value < product.price.value}">
                    <p class="price"><span class="price-label">${withinPackage}</span><format:price
                            priceData="${product.lowestBundlePrice}"/></p>
                ...
                <c:if test="${fn:contains(product.url, 'Add-Ons')}"><p
                        class="price-frequency">${product.subscriptionTerm.billingPlan.billingTime.name}</p></c:if>
                <c:if test="${fn:contains(product.url, 'Plans')}"><p
                        class="price-frequency">${product.subscriptionTerm.billingPlan.billingTime.name}</p></c:if>
            </ycommerce:testId>
