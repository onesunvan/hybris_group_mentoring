...
<ycommerce:testId code="product_wholeProduct">
    ...
    <form:form id="oneClickBuyForm" action="${oneClickBuy}" method="post">
                    ...
                    <p class="prod_review-info">
                        <c:choose>
                            <c:when test="${(product.numberOfReviews) > 1}">
                                <a href="#" id="based_on_reviews"><spring:theme code="review.based.on"
                                                                                arguments="${product.numberOfReviews}"/></a>
                            </c:when>
                            <c:otherwise>
                                <a href="#" id="based_on_reviews"><spring:theme code="review.based.on.one"
                                                                                arguments="${product.numberOfReviews}"/></a>
                            </c:otherwise>
                        </c:choose>
                    </p>
        ...
        <div class="viewplan" data-row="2">
            <div class="header"><spring:theme code="product.list.viewplans.billingFrequency"
                                              text="Billing Frequency"/></div>
        ...
        <div class="viewplan" data-row="3">
            ...
            <div class="content">
                <c:if test="${not empty product.price.recurringChargeEntries}">
                    ...
                    <c:forEach items="${product.price.recurringChargeEntries}" var="recurringPrice"
                ...
                <c:if test="${not empty product.price.oneTimeChargeEntries}">
                    ...
                    <c:forEach items="${product.price.oneTimeChargeEntries}" var="oneTimePrice"
        ...
        <div class="viewplan" data-row="4">
            <div class="header"><spring:theme code="product.list.viewplans.termOfServiceFrequency"
                                              text="Term of service frequency"/></div>
            <div class="content">
        ...
        <div class="viewplan" data-row="5">
            <div class="header"><spring:theme code="product.list.viewplans.termOfServiceRenewal"
                                              text="Term of service renewal"/></div>
            <div class="content">
                                ...
                                <c:forEach items="${usageCharge.usageChargeEntries}" var="usageChargeEntry">
                                        ...
                                        <c:if test="${usageCharge['class'].simpleName eq 'PerUnitUsageChargeData'}">
                                            ...
                                            <c:if test="${not isFirstChargeEntry}">
                                                ...
                                                <c:if test="${usageCharge.usageChargeType.code eq 'highest_applicable_tier'}">
                                                    <spring:theme
                                                            code="product.list.viewplans.tierUsageChargeEntryHighestTier"
                                                            arguments="${usageChargeEntry.tierStart}^${usageChargeEntry.tierEnd}^^${usageChargeEntry.price.formattedValue}^${usageCharge.usageUnit.name}"
                                                            argumentSeparator="^"/><br>
                                                </c:if>
                                            </c:if>
                                        ...
                                        <c:if test="${usageCharge['class'].simpleName eq 'VolumeUsageChargeData'}">
                                            <c:if test="${isFirstChargeEntry}">
                                                <spring:theme code="product.list.viewplans.volumeTierUsageChargeEntry"
                                                              arguments="${usageChargeEntry.tierStart}^${usageChargeEntry.tierEnd}^^${usageChargeEntry.price.formattedValue}"
                                                              argumentSeparator="^"/><br>
                                            </c:if>
                                            <c:if test="${not isFirstChargeEntry}">
                                                <spring:theme
                                                        code="product.list.viewplans.volumeTierUsageChargeEntryNotFirstTier"
                                                        arguments="${usageChargeEntry.tierStart}^${usageChargeEntry.tierEnd}^^${usageChargeEntry.price.formattedValue}"
                                                        argumentSeparator="^"/><br>
                                            </c:if>
                                        </c:if>
                                    ...
                                    <c:if test="${usageChargeEntry['class'].simpleName eq 'OverageUsageChargeEntryData' and fn:length(usageCharge.usageChargeEntries) gt 1}">
                                        <c:if test="${usageCharge['class'].simpleName eq 'PerUnitUsageChargeData' and usageCharge.usageChargeType.code eq 'each_respective_tier'}">
                                            <spring:theme
                                                    code="product.list.viewplans.thereafterOverageUsageChargeEntry"
                                        ...
                                        <c:if test="${usageCharge['class'].simpleName eq 'PerUnitUsageChargeData' and usageCharge.usageChargeType.code eq 'highest_applicable_tier'}">
                                            <spring:theme
                                                    code="product.list.viewplans.thereafterOverageUsageChargeEntryHighestTier"
                                                    arguments="${usageChargeEntry.price.formattedValue},${usageCharge.usageUnit.name}"/>
                                        </c:if>
                                        <c:if test="${usageCharge['class'].simpleName eq 'VolumeUsageChargeData'}">
                                            <spring:theme
                                                    code="product.list.viewplans.thereafterOverageUsageChargeEntryVolume"
                                                    arguments="${usageChargeEntry.price.formattedValue},${usageCharge.usageUnit.name}"/>
                                        </c:if>
                                    </c:if>
                                    <c:if test="${usageChargeEntry['class'].simpleName eq 'OverageUsageChargeEntryData' and fn:length(usageCharge.usageChargeEntries) eq 1}">
                                        <spring:theme code="product.list.viewplans.overageUsageChargeEntry"
                                                      arguments="${usageChargeEntry.price.formattedValue},${usageCharge.usageUnit.name}"/>
                                    </c:if>
