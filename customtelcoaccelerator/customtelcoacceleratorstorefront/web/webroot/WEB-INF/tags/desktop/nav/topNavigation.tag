...
<div id="nav_main" class="nav_main">
    ...
    <ul class="clear_fix">
        <li class="home-navigation"><a href="<c:url value="/"/>"
                                       title="<spring:theme code="general.homeButton" text="Home Button"/>"><spring:theme
                code="general.homeButton" text="Home Button"/></a></li>
        ...
        <li class="search">
            <form name="search_form" method="get" action="<c:url value="/search"/>">
                ...
                <ycommerce:testId code="header_search_input">
                    <input id="search" class="text" type="text" name="text" value="" maxlength="100"
                           placeholder="${searchPlaceholder}"/>
                </ycommerce:testId>
                <ycommerce:testId code="header_search_button">
                    <spring:theme code="img.searchButton" text="/" var="searchButtonPath"/>
                    <input class="button" type="image" title="${searchText}" src="<c:url value="${searchButtonPath}"/>"
                           alt="${searchText}"/>
                </ycommerce:testId>
            </form>
