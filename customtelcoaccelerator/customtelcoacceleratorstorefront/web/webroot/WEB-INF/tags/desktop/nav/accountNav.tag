            ...
            <ul class="facet_block indent">
                <li class='${selected eq 'profile' ? 'nav_selected' : ''}'>
                    ...
                    <ycommerce:testId code="myAccount_profile_navLink">
                        <a href="${encodedUrl}"
                           title="<spring:theme code="text.account.profile" text="Profile"/>"><spring:theme
                ...
                <li class='${selected eq 'address-book' ? 'nav_selected' : ''}'>
                    ...
                    <ycommerce:testId code="myAccount_addressBook_navLink">
                        <a href="${encodedUrl}"
                           title="<spring:theme code="text.account.addressBook" text="Address Book"/>"><spring:theme
                ...
                <li class='${selected eq 'payment-details' ? 'nav_selected' : ''}'>
                    ...
                    <ycommerce:testId code="myAccount_paymentDetails_navLink">
                        <a href="${encodedUrl}"
                           title="<spring:theme code="text.account.paymentDetails" text="Payment Details"/>"><spring:theme
                ...
                <li class='${selected eq 'orders' ? 'nav_selected' : ''}'>
                    ...
                    <ycommerce:testId code="myAccount_orders_navLink">
                        <a href="${encodedUrl}"
                           title="<spring:theme code="text.account.orderHistory" text="Order History"/>"><spring:theme
                ...
                <li class='${selected eq 'subscriptions' ? 'nav_selected' : ''}'>
                    ...
                    <ycommerce:testId code="myAccount_subscriptions_navLink">
                        <a href="${encodedUrl}"
                           title="<spring:theme code="text.account.subscriptions" text="Subscriptions"/>"><spring:theme
                                code="text.account.subscriptions" text="Subscriptions"/></a>
                    </ycommerce:testId>
                </li>
                <li class='${selected eq 'entitlements' ? 'nav_selected' : ''}'>
                    ...
                    <ycommerce:testId code="myAccount_entitlements_navLink">
                        <a href="${encodedUrl}"
                           title="<spring:theme code="text.account.entitlements" text="Access & Entitlements"/>"><spring:theme
                                code="text.account.entitlements" text="Access & Entitlements"/></a>
                    </ycommerce:testId>
                </li>
            </ul>
        </div>
