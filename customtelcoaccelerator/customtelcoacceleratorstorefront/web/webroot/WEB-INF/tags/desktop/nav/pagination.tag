        ...
        <div class="prod_refine-box prod_refine-sort">
            <form id="sort_form${top ? '1' : '2'}" name="sort_form${top ? '1' : '2'}" method="get" action="#">
                ...
                <c:catch var="errorException">
                    <spring:eval expression="searchPageData.currentQuery.query.value"
        ...
        <li class="pager-back">
            ...
            <c:if test="${hasPreviousPage}">
                ...
                <ycommerce:testId code="searchResults_previousPage_link">
                    <a href="${previousPageUrl}" class="pager-back-link"
                       title="<spring:theme code="${themeMsgKey}.linkPreviousPage"/>">
                    </a>
                </ycommerce:testId>
            </c:if>
        ...
        <li class="pager-next">
            ...
            <c:if test="${hasNextPage}">
                ...
                <ycommerce:testId code="searchResults_nextPage_link">
                    <a href="${nextPageUrl}" class="pager-next-link"
                       title="<spring:theme code="${themeMsgKey}.linkNextPage"/>">
                    </a>
                </ycommerce:testId>
            </c:if>
