            ...
            <div class="facetValues">
                <c:if test="${not empty facetData.topValues}">
                    <div class="topFacetValues">
                                ...
                                <li>
                                    <c:if test="${facetData.multiSelect}">
                                        <form action="#" method="get">
                                            ...
                                            <input title="${facetValue.name}" type="hidden" name="text"
                                    ...
                                    <c:if test="${not facetData.multiSelect}">
                                        ...
                                        <a href="${facetValueQueryUrl}&amp;text=${searchPageData.freeTextSearch}"
                                           title="${facetValue.name}">${facetValue.name}</a>
                                        <spring:theme code="search.nav.facetValueCount"
                                                      arguments="${facetValue.count}"/>
                                    </c:if>
                                </li>
						...
						<span class="more">
							<a href="#" title="<spring:theme code="search.nav.facetShowMore_${facetData.code}" />"
                               onclick="$(this).closest('div.topFacetValues').hide().siblings('div.allFacetValues').show();return false;"><spring:theme
                ...
                <div class="allFacetValues" style="${not empty facetData.topValues ? 'display:none' : ''}">
                            ...
                            <li>
                                <c:if test="${facetData.multiSelect}">
                                    <form action="#" method="get">
                                        ...
                                        <label class="facet_block-label" title="${facetValue.name}">
                                            <input type="checkbox"
                                                   title="${facetValue.name}" ${facetValue.selected ? 'checked="checked"' : ''}
                                                   onchange="$(this).closest('form').submit()"/>
                                                ${facetValue.name}
                                        </label>
                                        <spring:theme code="search.nav.facetValueCount"
                    ...
                    <c:if test="${not empty facetData.topValues}">
						<span class="more">
							<a href="#"
                               onclick="$(this).closest('div.allFacetValues').hide().siblings('div.topFacetValues').show();return false;"><spring:theme
