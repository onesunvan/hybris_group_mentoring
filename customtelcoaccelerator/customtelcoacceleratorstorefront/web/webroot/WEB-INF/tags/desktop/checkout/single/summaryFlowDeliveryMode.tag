...
<script id="deliveryModeSummaryTemplate" type="text/x-jquery-tmpl">
    ...
    <a href="#" class="edit_complete change_mode_button"><spring:theme
        code="checkout.summary.deliveryMode.editDeliveryMethod"/></a>
</ycommerce:testId>
		{{else}}
		<ycommerce:testId code="checkout_changeDeliveryMode_element">
...
<script id="deliveryModeButton" type="text/x-jquery-tmpl">
    ...
    <button class="form" id="use_this_delivery_method"><spring:theme
        code="checkout.summary.deliveryMode.useThisDeliveryMethod"/></button>
</ycommerce:testId>
	{{/if}}
...
<div class="checkout_summary_flow_b ${deliveryModeOk ? 'complete' : ''}" id="checkout_summary_deliverymode_div">
    ...
    <ycommerce:testId code="checkout_changeDeliveryMode_element">
        <c:choose>
            ...
            <c:otherwise>
                <button class="form change_mode_button"><spring:theme
                        code="checkout.summary.deliveryMode.editDeliveryMethod"/></button>
            </c:otherwise>
        </c:choose>
    </ycommerce:testId>
</div>
