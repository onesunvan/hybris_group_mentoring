...
<div class="checkout_summary_flow_c complete" id="checkout_summary_payment_div">
                ...
                <div class="right">
                    <ul>
                        <c:if test="${billingAddressOk}">
                            ...
                            <li><c:if
                                    test="${not empty paymentInfo.billingAddress.title}">${fn:escapeXml(paymentInfo.billingAddress.title)}&nbsp;</c:if>${fn:escapeXml(paymentInfo.billingAddress.firstName)}
    ...
    <ycommerce:testId code="checkout_changePayment_element">
        <a href="<c:url value="/checkout/multi/choose-payment-method"/>"
           class="edit_complete change_payment_method_button"><spring:theme
