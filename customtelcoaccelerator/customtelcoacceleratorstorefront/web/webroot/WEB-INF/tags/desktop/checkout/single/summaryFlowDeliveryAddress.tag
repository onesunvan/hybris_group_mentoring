...
<script id="deliveryAddressSummaryTemplate" type="text/x-jquery-tmpl">
    ...
    <a href="#" class="edit_complete change_address_button" address-id="{{= deliveryAddress.id}}"><spring:theme
        code="checkout.summary.deliveryAddress.editDeliveryAddressButton"/></a>
</ycommerce:testId>
		{{else}}
				<ycommerce:testId code="checkout_changeAddress_element">
    <button class="form change_address_button" address-id="{{= deliveryAddress.id}}"><spring:theme
        code="checkout.summary.deliveryAddress.enterDeliveryAddressButton"/></button>
</ycommerce:testId>
		{{/if}}
	</div>
		...
		<form>
			{{each addresses}}
				<div class="existing_address">
					...
					<button class="form right pad_left use_address" address-id="{{= $value.id}}"><spring:theme
        code="checkout.summary.deliveryAddress.useThisAddress"/></button>
					<button class="form right edit" address-id="{{= $value.id}}"><spring:theme
        code="checkout.summary.deliveryAddress.edit"/></button>
				</div>
			{{/each}}
		</form>
	{{/if}}
