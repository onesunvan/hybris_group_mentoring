...
<div class="item_container_holder">
    ...
    <div class="item_container">
        ...
        <form:form method="post" commandName="registerForm" action="${action}">
            <dl>
                <formElement:formSelectBox idKey="register.title" labelKey="register.title" path="titleCode"
                ...
                <formElement:formInputBox idKey="register.lastName" labelKey="register.lastName" path="lastName"
                                          inputCSS="text" mandatory="true"/>
                <formElement:formInputBox idKey="register.email" labelKey="register.email" path="email" inputCSS="text"
                                          mandatory="true"/>
                ...
                <formElement:formPasswordBox idKey="register.checkPwd" labelKey="register.checkPwd" path="checkPwd"
                                             inputCSS="text password" mandatory="true" errorPath="registerForm"/>
                    <%--for captchaaddon--%>
