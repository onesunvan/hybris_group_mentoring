    ...
    <div class="prod_add_to_cart">
        <div class="tabs">
            <c:forEach items="${upgradeOptions}" var="upgradeOptionTab" varStatus="upgradeOptionTabCounter">
                ...
                <h2 <c:if
                        test="${upgradeOptionTab.preselected}"> id="preselected"</c:if>>${upgradeOptionTab.name}</h2> <!-- TODO please preselect -->
                ...
                <div class="tabbody">
                    ...
                    <table class="account-upgrade-subscription-table">
                        ...
                        <tr>
                            ...
                            <th width="30%">
                                <div class="info-line center"><spring:theme
                                        code="text.account.subscriptions.upgrade.change" text="Change"/></div>
                            </th>
                            <th width="35%">
                        ...
                        <tr>
                            ...
                            <td class="change_col">
                                ...
                                <img class="equalCheck"
                                     src="${commonResourcePath}/../theme-blue-telco-extension/images/icon-checkout-summary-flow-tick.png"/>
                            </td>
                        ...
                        <tr>
                            ...
                            <td class="change_col">
                                <spring:theme code="product.list.viewplans.termOfServiceFrequency"
                                              text="Term of service frequency"/>
                                <img class="equalCheck"
                                     src="${commonResourcePath}/../theme-blue-telco-extension/images/icon-checkout-summary-flow-tick.png"/>
                            </td>
                    ...
                    <c:url value="/my-account/subscription/${subscriptionData.id}"
                           var="myAccountSubscriptionDetailsUrl"/>
                    <button class="r_action_btn default" type="button"
                            onclick="window.location='${myAccountSubscriptionDetailsUrl}'">
                        <spring:theme code="text.account.subscription.returnToCurrentPlan"
                                      text="Return to Current Plan"/>
                    </button>

                    <form:form class="upgrade_subscription_form right"
                               id="upgradeSubscriptionForm_${subscriptionData.id}_${upgradeOptionTab.code}"
                        ...
                        <button id="addUpgradeButton" type="${buttonTypeUpgrade}"
                                title="<spring:theme code="${buttonTooltip}"/>"
                                class="p_action_btn positive right <c:if test="${isSubscriptionUpgradable eq false}">not-upgradable</c:if>">
                    ...
                    <button class="function_btn right viewPotentialUpgradeBillingDetails"
                            data-url="/customtelcoacceleratorstorefront/my-account/viewPotentialUpgradeBillingDetails?subscriptionId=${subscriptionData.id}&upgradeId=${upgradeOptionTab.code}">
                        <spring:theme code="text.account.subscription.previewBillingChanges"
                                      text="View Billing Changes"/>
                    </button>
                </div>
            </c:forEach>
        </div>
