            ...
            <div class="item_container">
                <c:if test="${not empty searchPageData.results}">
                    ...
                    <table class="account-table">
                        <thead>
                        <tr>
                            <th id="header1"><spring:theme code="text.account.orderHistory.orderNumber"
                                                           text="Order Number"/></th>
                            <th id="header2"><spring:theme code="text.account.orderHistory.orderStatus"
                                                           text="Order Status"/></th>
                            <th id="header3"><spring:theme code="text.account.orderHistory.datePlaced"
                                                           text="Date Placed"/></th>
                            <th id="header4"><spring:theme code="text.account.orderHistory.actions"
                                                           text="Actions"/></th>
                        </tr>
                        </thead>
                        <tbody>
                                            ...
                                            <li>
                                                <a href="${myAccountOrderDetailsUrl}"
                                                   class="function_btn btn_add"><spring:theme
                                                        code="text.account.orderHistory.viewDetails"
                                                        text="View Details"/></a>
                                            </li>
                                        </ycommerce:testId>
                                    </ul>
