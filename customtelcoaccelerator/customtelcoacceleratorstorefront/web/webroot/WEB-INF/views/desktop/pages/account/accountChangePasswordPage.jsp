    ...
    <div class="span-20 last">
        <div class="item_container_holder updatePassword">
            ...
            <div class="item_container">
                <p><spring:theme code="text.account.profile.updatePassword"
                                 text="Please use this form to update your account password"/></p>
                ...
                <form:form action="update-password" method="post" commandName="updatePasswordForm" autocomplete="off">
                    <dl>
                        <formElement:formPasswordBox idKey="profile.currentPassword" labelKey="profile.currentPassword"
                                                     path="currentPassword" inputCSS="text password" mandatory="true"/>
                        <formElement:formPasswordBox idKey="profile-newPassword" labelKey="profile.newPassword"
                                                     path="newPassword" inputCSS="text password strength"
                                                     mandatory="true"/>
					...
					<ycommerce:testId code="profilePage_SaveUpdatePasswordButton">
                        ...
                        <a onclick="window.location='${backToProfile}'"
                           class="r_action_btn action_btn_add"><spring:theme code="text.account.profile.cancelUpdate"
                                                                             text="Cancel"/></a>
                        <button class="positive"><spring:theme code="text.account.profile.updatePasswordForm"
                                                               text="Update Password"/></button>
                    </ycommerce:testId>
					</span>
                </form:form>
            </div>
