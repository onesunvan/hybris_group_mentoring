        ...
        <div class="span-24 multicheckout">
            <div class="item_container_holder">
                ...
                <div class="item_container">
                    <p><spring:theme code="checkout.multi.addEditform"
                                     text="Please use this form to add/edit an address."/></p>
                    ...
                    <form:form method="post" commandName="addressForm">
                        <dl>
                            ...
                            <formElement:formInputBox idKey="address.townCity" labelKey="address.townCity"
                                                      path="townCity" inputCSS="text" mandatory="true"/>
                            ...
                            <c:if test="${not addressForm.defaultAddress and not firstAddress}">
                                <formElement:formCheckbox idKey="address.default" labelKey="address.default"
						...
						<c:if test="${not noAddress}">
                            <ycommerce:testId code="multicheckout_cancel_button">
                                <a href="${chooseDeliveryAddressUrl}">
                                    <button class="r_action_btn" type="button"><spring:theme
                                            code="checkout.multi.cancel" text="Cancel"/></button>
                                </a>
                            </ycommerce:testId>
                        </c:if>
						<ycommerce:testId code="multicheckout_saveAddress_button">
                            <button class="positive"><spring:theme code="checkout.multi.saveAddress"
                                                                   text="Save address"/></button>
                        </ycommerce:testId>
					</span>
                    </form:form>
                </div>
