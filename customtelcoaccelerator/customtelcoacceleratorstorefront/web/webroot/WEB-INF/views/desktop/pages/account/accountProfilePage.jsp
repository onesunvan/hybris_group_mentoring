                ...
                <table class="account-table no-margin">
                    ...
                    <tr>
                        ...
                        <td headers="header2" class="actions background">
                            <ul>
                                <li>
                                    <a href="update-profile" class="positive btn_add"><spring:theme
                                            code="text.account.profile.updatePersonalDetails"
                                            text="Update personal details"/></a>
                                </li>
                                <li>
                                    <a href="update-email" class="positive btn_add"><spring:theme
                                            code="text.account.profile.updateEmail" text="Update email"/></a>
                                </li>
                                <li>
                                    <a href="update-password" class="positive btn_add"><spring:theme
