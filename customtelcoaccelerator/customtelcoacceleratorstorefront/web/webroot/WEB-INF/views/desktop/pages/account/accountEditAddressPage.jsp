    ...
    <div class="span-20 last">
        <div class="item_container_holder addressDetails">
            ...
            <div class="item_container">
                <p><spring:theme code="text.account.addressBook.addEditform"
                                 text="Please use this form to add/edit a delivery address"/></p>
                ...
                <form:form action="add-address" method="post" commandName="addressForm">
					...
					<span class="form_btns" style="display: block; clear: both;">
						...
						<ycommerce:testId code="accountEditAddress_SaveAddress_button">
                            <button class="positive"><spring:theme code="text.account.addressBook.saveAddress"
                                                                   text="Save New Address"/></button>
                        </ycommerce:testId>
					</span>
                </form:form>
            </div>
