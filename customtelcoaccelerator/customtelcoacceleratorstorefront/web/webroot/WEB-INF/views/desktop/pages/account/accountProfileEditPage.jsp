    ...
    <div class="span-20 last">
        <div class="item_container_holder updateProfile">
            ...
            <div class="item_container">
                <p><spring:theme code="text.account.profile.updateForm"
                                 text="Please use this form to update your personal details"/></p>
                ...
                <form:form action="update-profile" method="post" commandName="updateProfileForm">
                    <dl>
                        ...
                        <formElement:formInputBox idKey="profile.firstName" labelKey="profile.firstName"
					...
					<ycommerce:testId code="profilePage_SaveUpdatesButton">
                        ...
                        <a onclick="window.location='${backToProfile}'"
                           class="r_action_btn action_btn_add"><spring:theme code="text.account.profile.cancelUpdate"
                                                                             text="Cancel"/></a>
                        <button class="positive"><spring:theme code="text.account.profile.saveUpdates"
