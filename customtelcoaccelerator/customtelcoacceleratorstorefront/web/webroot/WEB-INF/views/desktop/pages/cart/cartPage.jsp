        ...
        <c:if test="${not empty cartData.entries}">
            ...
            <div class="span-24 cart-actions last">
                ...
                <button id="checkoutButtonBottom"
                        class="positive right <c:if test="${cartData.cartInvalidMessage != null}">cart-invalid-button</c:if>"
                        <c:if test="${cartData.cartInvalidMessage == null}">onclick="doCheckout()"</c:if>>
                    ...
                    <div class="invalid-bundle-wizard">
                        <c:forEach var="invalidMap" items="${cartData.firstIncompleteBundleComponentsMap}">
                            <a href="<c:url value="/bundle/edit-component/${invalidMap.key}/component/${invalidMap.value.id}"/>"
                               class="invalid-bundle-wizard-editable">
