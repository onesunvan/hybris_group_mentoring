    ...
    <div class="span-20 last">
        ...
        <div class="item_container_holder subscription_billing_activity">
            ...
            <div class="item_container">
                    ...
                    <table id="billingActivities">
                        ...
                        <tr>
                            <th id="header1"><spring:theme
                                    code="text.account.subscription.billingActivity.billingPeriod"
                                    text="Billing Period"/></th>
                            <th id="header2"><spring:theme code="text.account.subscription.billingActivity.billingDate"
                                                           text="Billing Date"/></th>
                            <th id="header3"><spring:theme
                                    code="text.account.subscription.billingActivity.paymentAmount"
                                    text="Payment Amount"/></th>
                            <th id="header4"><spring:theme
                                    code="text.account.subscription.billingActivity.paymentStatus"
                        ...
                        <c:forEach items="${billingActivities}" var="billingActivity">
                            ...
                            <c:url value="/my-account/downloadSubscriptionBillingActivityDetail"
                                   var="billingActivityDetailUrl"/>
                            ...
                            <tr>
                                ...
                                <td headers="header5">
                                    <c:url value="/my-account/downloadSubscriptionBillingActivityDetail"
                                           var="downloadBillingActivityDetailUrl"/>
                                    <form:form class="resume_subscription_form" id="resumeSubscriptionForm"
                                               action="${downloadBillingActivityDetailUrl}" method="get">
                                        <c:if test="${billingActivity.paymentStatus == 'Paid'}">
                                            <button type="submit" class="function_btn left">
                                                <spring:theme code="text.account.subscription.billingActivity.download"
                                                              text="Download"/>
                                            </button>
                                            <input type="hidden" name="billingActivityId"
                                                   value="${billingActivity.billingId}"/>
                                        </c:if>
                                    </form:form>
                                </td>
                            </tr>
                ...
                <button type="submit" onclick="window.location='${backToSubscriptionDetails}'"
                        class="r_action_btn left"><spring:theme
                        code="text.account.subscription.returnToSubscriptionDetails"
                        text="Return To Subscription Details"/></button>
            </div>
        </div>
