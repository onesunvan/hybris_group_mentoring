    ...
    <c:if test="${targetArea ne 'accountArea'}">
        <script type="text/javascript">
            ...
            function setDeliveryAddress() {
                ...
                document.getElementById("address.townCity").value = "${deliveryAddress.town}";
                document.getElementById("address.postcode").value = "${deliveryAddress.postalCode}";
                        ...
                        <div class="payment_details_left_col">
                            ...
                            <dl>
                                ...
                                <formElement:formSelectBox idKey="payment.cardType"
                                                           labelKey="payment.cardType" path="cardTypeCode"
                                                           mandatory="true"
                                                           skipBlank="false"
                                ...
                                <template:errorSpanField path="startMonth">
                                    ...
                                    <dd>
                                        <form:select id="StartMonth" path="startMonth" cssClass="${cardDate}"
                                                     tabindex="4" disabled="${isEditMode}">
                                        ...
                                        <form:select id="StartYear" path="startYear" cssClass="${cardDate}" tabindex="5"
                                                     disabled="${isEditMode}">
                                    ...
                                    <dd>
                                        <template:errorSpanField path="expiryMonth">
                                            <form:select id="ExpiryMonth" path="expiryMonth" cssClass="${cardDate}"
                                                         tabindex="6" disabled="${isEditMode}">
                                                <option value="" label="<spring:theme code='payment.month'/>"/>
                                                <form:options items="${months}" itemValue="code" itemLabel="name"/>
                                            </form:select>
                                            <c:if test="${isEditMode}">
                                        ...
                                        <template:errorSpanField path="expiryYear">
                                            <form:select id="ExpiryYear" path="expiryYear" cssClass="${cardDate}"
                                                         tabindex="7" disabled="${isEditMode}">
                                                <option value="" label="<spring:theme code='payment.year'/>"/>
                                ...
                                <c:if test="${not isFirstPaymentMethod and not paymentInfo.defaultPaymentInfo}">
                                    <formElement:formCheckbox idKey="makeAsDefault" labelKey="payment.makeAsDefault"
                                                              path="makeAsDefault" mandatory="false"
                        ...
                        <div class="payment_details_right_col">
                            ...
                            <c:choose>
                                <c:when test="${targetArea ne 'accountArea'}">
                                    <p>
                                        <spring:theme
                                                code="checkout.multi.paymentMethod.addPaymentDetails.billingAddressDiffersFromDeliveryAddress"/>
                                    </p>
                                    <dl>
                                        <dt class="left">
                                            <form:checkbox id="differentAddress" path="newBillingAddress" tabindex="9"/>
                                            <label for="differentAddress" class="differentAddress"><spring:theme
                            ...
                            <c:if test="${isEditMode}">
                                <button class="form" type="button" onclick="clearBillingFields()">
                                    <spring:theme code="text.account.paymentDetails.edit.clearAddressFields"
                                                  text="Clear Address Fields"/>
                                </button>
                                <br><br>
                            </c:if>
                        ...
                        <div class="save_payment_details">
                                ...
                                <c:if test="${targetArea eq 'multiCheckoutArea'}">
                                    <button class="positive" tabindex="19" id="lastInTheForm">
                                        <spring:theme
                                                ...
                                                text="Save New Payment Details"/>
                                    </button>
                                </c:if>
                                <c:if test="${targetArea eq 'accountArea' && not isEditMode}">
                                    <button class="positive" tabindex="19" id="lastInTheForm">
                                        <spring:theme code="text.account.paymentDetails.saveNewPaymentDetails"
                                                      text="Save New Payment Details"/>
                                    </button>
                                </c:if>
                                <c:if test="${targetArea eq 'accountArea' && isEditMode}">
                                    <button class="positive" tabindex="19" id="lastInTheForm">
                                        <spring:theme code="text.account.paymentDetails.savePaymentDetails"
                            ...
                            <c:if test="${targetArea eq 'accountArea'}">
                                ...
                                <button class="r_action_btn right" style="margin-right: 10px;" type="button"
                                        onclick="window.location='${paymentDetails}'">
