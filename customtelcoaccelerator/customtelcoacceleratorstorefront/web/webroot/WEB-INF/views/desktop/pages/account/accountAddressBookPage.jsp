    ...
    <div class="span-20 last cust_acc-page">
        <div class="item_container_holder address_book">
            ...
            <div class="item_container">
                <p><spring:theme code="text.account.addressBook.manageYourAddresses"
                                 text="Manage your delivery addresses"/></p>
                                    ...
                                    <c:if test="${not address.defaultAddress}">
                                        <ycommerce:testId code="addressBook_isDefault_button">
                                            <a href="set-default-address/${address.id}"
                                               class="function_btn btn_add"><spring:theme
                                                    code="text.account.addressBook.makeDefault"
                                                    text="Set As Default"/></a>
                                        </ycommerce:testId>
                                    </c:if>
                                </td>
                                        ...
                                        <li>
                                            <ycommerce:testId code="addressBook_editAddress_button">
                                                <a href="edit-address/${address.id}"
                                                   class="positive btn_add"><spring:theme
                                                        code="text.account.addressBook.editAddress"
                                                        text="Edit Address"/></a>
                                            </ycommerce:testId>
                                        </li>
                                        <li>
                                            <ycommerce:testId code="addressBook_removeAddress_button">
                                                ...
                                                <a href="#" class="function_btn btn_add js-remove-address"
                                                   data-id="${address.id}"><spring:theme
                                                        code="text.account.addressBook.removeAddress"
                                                        text="Remove Address"/></a>

                                                <div style="display: none;">
                                                    <div id="remove-address-confirm-${address.id}"
                                                         class="remove-address-confirm">
                                                        <div class="title"><spring:theme
                                                                code="text.account.addressBook.confirmRemoval"
                                                                text="Confirm Removal"/></div>
                                                        <p><spring:theme
                                                                code="text.account.addressBook.removeAddress.confirmMessage"
                                                                text="Are you sure you would like to remove this delivery address"/></p>

                                                        <div class="actions">
                                                            <button type="button" class="cancel r_action_btn">
                                                                <spring:theme
                                                                        code="text.account.addressBook.removeAddress.cancel"
                                                                        text="No"/></button>
                                                            <button type="button"
                                                                    onclick="window.location='${removeAddress}'"
                                                                    class="confirm positive"><spring:theme
                                                                    code="text.account.addressBook.removeAddress.yes"
                                                                    text="Yes"/></button>
                                                        </div>
                                                    </div>
                                                </div>
