...
<template:page pageTitle="${pageTitle}">
    ...
    <div class="telco-checkout checkout-summary"> <!-- telco change -->
        ...
        <multi-checkout:summaryFlow deliveryAddress="${deliveryAddress}" deliveryMode="${deliveryMode}"
                                    paymentInfo="${paymentInfo}" requestSecurityCode="${requestSecurityCode}"/>
        ...
        <div class="span-24 last place-order">
            <form:form action="${placeOrderUrl}" id="placeOrderForm1" commandName="placeOrderForm">
                ...
                <button type="submit" class="positive right pad_right place-order"
                        onclick="placeOrderWithSecurityCode();return false;">
                    <spring:theme code="checkout.summary.placeOrder"/>
                </button>
                <div class="terms right">
                    <form:checkbox id="Terms1" name="Terms1" path="termsCheck"/>
                    <label for="Terms1"><spring:theme
                            code="checkout.summary.placeOrder.readTermsAndConditions"/></label>
                </div>
            </form:form>
        </div>
        ...
        <div class="span-24 place-order place-order-bottom">
            ...
            <form>
                ...
                <div class="terms right">
                    <input type="checkbox" id="Terms2" name="Terms2" value="Terms"><label for="Terms2"><spring:theme
                        code="checkout.summary.placeOrder.readTermsAndConditions"/></label>
                </div>
            </form>
        </div>
