...
<template:page pageTitle="${pageTitle}">
    ...
    <div id="item_container_holder">
        ...
        <div class="item_container">
            <form id="hostedOrderPagePostForm" name="hostedOrderPagePostForm" action="${hostedOrderPageData.postUrl}"
                  method="POST">
                        ...
                        <c:forEach items="${hostedOrderPageData.parameters}" var="entry" varStatus="status">
                            <c:choose>
                                <c:when test="${hostedOrderPageData.debugMode}">
                                    <dt><label for="${entry.key}" class="required"><c:out value="${entry.key}"/></label>
                                    </dt>
                                    <dd><input type="text" id="${entry.key}" name="${entry.key}" value="${entry.value}"
                ...
                <c:if test="${hostedOrderPageData.debugMode}">
                    <div class="rightcol">
                        ...
                        <input id="button.submit" class="submitButtonText" type="submit" title="${submitButtonLabel}"
