    ...
    <div class="span-20 last cust_acc-page">
        <div class="item_container_holder paymentDetails">
            ...
            <div class="item_container">
                <p><spring:theme code="text.account.paymentDetails.managePaymentDetails"
                                 text="Manage your saved payment details."/></p>
                <c:if test="${not empty paymentInfoData}">
                    ...
                    <table class="account-table">
                        <thead>
                        <tr>
                            <th id="header1"><spring:theme code="text.account.paymentDetails.paymentCard"
                                                           text="Payment Card"/></th>
                            <th id="header2"><spring:theme code="text.account.paymentDetails.billingAddress"
                                                           text="Billing Address"/></th>
                            ...
                            <tr>
                                <td headers="header1">
                                    <ul>
                                        ...
                                        <li><spring:theme code="text.expires.colon"
                                                          text="Expires:"/>&nbsp;${fn:escapeXml(paymentInfo.expiryMonth)}
                                ...
                                <td headers="header2" class="background">
                                    <ul>
                                        <li><c:out
                                                value="${fn:escapeXml(paymentInfo.billingAddress.title)} ${fn:escapeXml(paymentInfo.billingAddress.firstName)} ${fn:escapeXml(paymentInfo.billingAddress.lastName)}"/></li>
                                ...
                                <td headers="header3">
                                    ...
                                    <c:if test="${not paymentInfo.defaultPaymentInfo}">
                                        ...
                                        <form:form id="setDefaultPaymentDetails${paymentInfo.id}"
                                            ...
                                            <button type="button"
                                                    onclick="javascript:submitSetDefault(${paymentInfo.id});"
                                                    class="function_btn"><spring:theme
                                                    code="text.account.paymentDetails.makeDefault"
                                                    text="Set as default"/></button>
                                        </form:form>
                                    </c:if>
                                </td>
                                    ...
                                    <ul>
                                        ...
                                        <li>
                                            <c:if test="${subscriptionsPerPaymentMethod[paymentInfo.id] gt '0'}">
                                                <c:url value="/my-account/manage-payment-method?paymentInfoId=${paymentInfo.id}"
                                                       var="manageSubscriptionsUrl"/>
                                                <button type="button"
                                                        onclick="window.location='${manageSubscriptionsUrl}'"
                                                        class="positive">
                                                    <spring:theme code="text.account.paymentDetails.manageSubscriptions"
                                        ...
                                        <li>
                                            ...
                                            <div class="left">
                                                <c:if test="${subscriptionsPerPaymentMethod[paymentInfo.id] gt '0'}">
                                                    <c:url value="/my-account/payment-method-subscriptions?paymentInfoId=${paymentInfo.id}"
                                                           var="manageSubscriptionsUrl"/>
                                                    <button id="editWithSubscriptions" class="function_btn"
                                                            data-url="${manageSubscriptionsUrl}">
                                                ...
                                                <c:if test="${subscriptionsPerPaymentMethod[paymentInfo.id] eq '0'}">
                                                    ...
                                                    <button type="button"
                                                            onclick="window.location='${continueToEditPaymentDetailsUrl}'"
                                                            class="function_btn">
                                                        <spring:theme code="text.edit" text="Edit"/>
                                                    </button>
                                                </c:if>
                                            ...
                                            <div class="left">
                                                ...
                                                <button id="removeWithSubscriptions" class="function_btn"
                                                        data-url="${removePaymentActionUrl}">
                                                    <spring:theme
                                                            code="text.account.paymentDetails.removePaymentDetails"
                                                            text="Remove"/>
                                                </button>
                                            </div>
