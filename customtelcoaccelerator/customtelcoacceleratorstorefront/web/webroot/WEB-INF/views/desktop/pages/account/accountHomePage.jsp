            ...
            <div class="cust_acc">
                <div class="cust_acc_tile">
					...
					<span>
						...
						<a href="${encodedUrl}"><theme:image code="img.account.profile" alt="${textAccountProfile}"
                                                             title="${textAccountProfile}"/></a>
					</span>
                    ...
                    <ul>
                        <ycommerce:testId code="myAccount_options_profile_groupbox">
                            ...
                            <li><a href="${encodedUrl}"><spring:theme code="text.account.profile.updatePersonalDetails"
                                                                      text="Update personal details"/></a></li>
                            <c:url value="/my-account/update-password" var="encodedUrl"/>
                            <li><a href="${encodedUrl}"><spring:theme code="text.account.profile.changePassword"
                ...
                <div class="cust_acc_tile">
					...
					<span>
						...
						<a href="${encodedUrl}"><theme:image code="img.account.addressBook"
                                                             alt="${textAccountAddressBook}"
                                                             title="${textAccountAddressBook}"/></a>
					</span>

                    <h1><a href="${encodedUrl}"><spring:theme code="text.account.addressBook" text="Address Book"/></a>
                    </h1>
                    <ul>
                ...
                <div class="cust_acc_tile">
					...
					<span>
						...
						<a href="${encodedUrl}"><theme:image code="img.account.paymentDetails"
                                                             alt="${textAccountPaymentDetails}"
                                                             title="${textAccountPaymentDetails}"/></a>
					</span>

                    <h1><a href="${encodedUrl}"><spring:theme code="text.account.paymentDetails"
                                                              text="Payment Details"/></a></h1>
                    <ul>
                ...
                <div class="cust_acc_tile">
					...
					<span>
						...
						<a href="${encodedUrl}"><theme:image code="img.account.orderHistory"
                                                             alt="${textAccountOrderHistory}"
                                                             title="${textAccountOrderHistory}"/></a>
					</span>

                    <h1><a href="${encodedUrl}"><spring:theme code="text.account.orderHistory"
                                                              text="Order History"/></a></h1>
                    <ul>
                        <ycommerce:testId code="myAccount_options_orderHistory_groupbox">
                            <li><a href="${encodedUrl}"><spring:theme code="text.account.viewOrderHistory"
                ...
                <div class="cust_acc_tile">
					...
					<span>
						...
						<a href="${encodedUrl}"><theme:image code="img.account.subscriptions"
                                                             alt="${textAccountSubscriptions}"
                                                             title="${textAccountSubscriptions}"/></a>
					</span>

                    <h1><a href="${encodedUrl}"><spring:theme code="text.account.subscriptions"
                                                              text="Subscriptions"/></a></h1>
                    <ul>
                        <ycommerce:testId code="myAccount_options_subscriptions_groupbox">
                            <li><a href="${encodedUrl}"><spring:theme code="text.account.manageSubscriptions"
                                                                      text="Manage subscriptions"/></a></li>
                        </ycommerce:testId>
                    </ul>
                </div>
                <div class="cust_acc_tile">
					...
					<span>
						...
						<a href="${encodedUrl}"><theme:image code="img.account.entitlements"
                                                             alt="${textAccountEntitlements}"
                                                             title="${textAccountEntitlements}"/></a>
					</span>

                    <h1><a href="${encodedUrl}"><spring:theme code="text.account.entitlements" text="Entitlements"/></a>
                    </h1>
                    <ul>
                        <ycommerce:testId code="myAccount_options_entitlements_groupbox">
                            <li><a href="${encodedUrl}"><spring:theme code="text.account.showEntitlements"
                                                                      text="Show your Entitlements"/></a></li>
                        </ycommerce:testId>
                    </ul>
                </div>
            </div>
