...
public interface GuidedSellingService {
     ...
     *
     * @param masterAbstractOrder the master cart/order
     * @param bundleTemplate      the component for which the subsequent component is searched
     * @param bundleNo            the number of the bundle the <code>bundleTemplate<code> belongs to
     ...
     *
     * @param masterAbstractOrder the master cart/order
     * @param bundleTemplate      the component which is checked
     * @param bundleNo            the number of the bundle the <code>bundleTemplate<code> belongs to
     * @param clazzes             classes of the products that are displayed on the extras page (e.g. ServiceAddOnModel.class)
