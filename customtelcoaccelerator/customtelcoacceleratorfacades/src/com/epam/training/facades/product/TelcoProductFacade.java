...
public interface TelcoProductFacade extends ProductFacade {
     ...
     *
     * @param code
     * @param referenceTypes           {@link List} of {@link ProductReferenceTypeEnum}s
     * @param options                  {@link List} of {@link ProductOption}s
     * @param limit
     * @param classAttributeAssignment
     * @param targetItemType           item type that is expected back in service
