...
public class DeviceBundleTabsPopulator<SOURCEPRODUCT extends DeviceModel, TARGETPRODUCT extends ProductData, SOURCETEMPLATE extends BundleTemplateModel>
     ...
     *
     * @param productModel the {@link ProductModel} for which the components should be searched for
     ...
     *
     * @param sourceComponent The source component {@link BundleTemplateModel} for which the target component should be found.
     ...
     *
     * @param productModel    the {@link ProductModel} for which the list of {@link ProductModel}s should be found
     * @param sourceComponent the source component {@link BundleTemplateModel} for which the list of {@link ProductModel}s should be
     *                        found
     * @param targetComponent the target component {@link BundleTemplateModel} for which the list of {@link ProductModel}s should be
     *                        found
     ...
     *
     * @param sourceComponent          in this case e.g. the "Smartphone-Handset" component
     * @param targetComponent          in this case e.g. the "Smartphone-Plan" component
     * @param productModel             in this case the Model of the device product
     * @param productData              in this case the DTO of the device product
     * @param subscriptionProductModel in this case the Model of the plan product
     * @param subscriptionProductData  in this case the DTO of the plan product
     */
    @Override
