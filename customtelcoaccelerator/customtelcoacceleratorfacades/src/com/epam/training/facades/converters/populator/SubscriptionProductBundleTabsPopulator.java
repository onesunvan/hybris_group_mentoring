...
public class SubscriptionProductBundleTabsPopulator<SOURCEPRODUCT extends SubscriptionProductModel, TARGETPRODUCT extends ProductData, SOURCETEMPLATE extends BundleTemplateModel>
     ...
     * @param sourceComponent not used here
     * @param targetComponent not used here
     ...
     *
     * @param sourceComponent          not used in this case
     * @param targetComponent          not used in this case
     * @param productData              not used in this case
     * @param productModel             not used in this case
     * @param subscriptionProductModel in this case the DTO of the plan product
     * @param subscriptionProductData  in this case the Model of the plan product
     */
    @Override
