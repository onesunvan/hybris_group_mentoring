...
public interface GuidedSellingFacade {
     ...
     *
     * @param bundleTemplateId the component to check
     ...
     *
     * @param bundleNo         the current bundleNo
     * @param bundleTemplateId the current bundleTemplate
     * @param relativeposition the relative position to jump to
     ...
     *
     * @param bundleNo         indicates to which bundle the product shall be added
     * @param bundleTemplateId The bundletemplate id to which the extras belong
     ...
     * @param urlPrefix    the URL prefix to be replaced
     ...
     *
     * @param bundleNo         current bundle number
     * @param currentComponent current component that is edited
