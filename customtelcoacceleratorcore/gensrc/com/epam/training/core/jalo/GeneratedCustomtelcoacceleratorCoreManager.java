...
{
	/** Relation ordering override parameter constants for customerorganisation from ((customtelcoacceleratorcore))*/
	protected static String CUSTOMERORGANISATION_SRC_ORDERED = "relation.customerorganisation.source.ordered";
	protected static String CUSTOMERORGANISATION_TGT_ORDERED = "relation.customerorganisation.target.ordered";
	/** Relation disable markmodifed parameter constants for customerorganisation from ((customtelcoacceleratorcore))*/
	protected static String CUSTOMERORGANISATION_MARKMODIFIED = "relation.customerorganisation.markmodified";
	/**
	...
	**/
	...
	public Collection<Organisation> getOrganisations(final SessionContext ctx, final Customer item)
	{
		final List<Organisation> items = item.getLinkedItems( 
			ctx,
			true,
			CustomtelcoacceleratorCoreConstants.Relations.CUSTOMERORGANISATION,
			null,
			false,
			false
		);
	...
	public void setOrganisations(final SessionContext ctx, final Customer item, final Collection<Organisation> value)
	{
		item.setLinkedItems( 
			...
			false,
			false,
			Utilities.getMarkModifiedOverride(CUSTOMERORGANISATION_MARKMODIFIED)
		);
	}
